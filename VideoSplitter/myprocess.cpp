...
myProcess::myProcess(int firstImageP, int numImagesP) : QObject(),firstImage(firstImageP),
    numImages(numImagesP),worker(this),progress(0.0)
{
...
void myProcess::start()
{
    ...
    worker.start(program, arguments);
}
